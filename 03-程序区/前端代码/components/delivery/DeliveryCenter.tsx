  ...
  return (
    <div className="module-workspace flex h-full min-h-0 flex-col">
      <Tabs value={activeSection} onValueChange={(value) => setActiveSection(value as typeof activeSection)} className="ui-module-toolbar mx-16 h-14 shrink-0 border-0 px-0 shadow-none">
        <TabsList aria-label="知识中心内容" className="h-8 gap-0 rounded-lg bg-muted p-0.5 shadow-none"><TabsTrigger value="notes" className="h-7 border-0 px-4 text-xs shadow-none data-[state=active]:bg-background data-[state=active]:shadow-sm">笔记</TabsTrigger><TabsTrigger value="documents" className="h-7 border-0 px-4 text-xs shadow-none data-[state=active]:bg-background data-[state=active]:shadow-sm">知识</TabsTrigger><TabsTrigger value="prompts" className="h-7 border-0 px-4 text-xs shadow-none data-[state=active]:bg-background data-[state=active]:shadow-sm">提示词</TabsTrigger></TabsList>
